...
/**
 * RelationshipModal — create a new relationship between two people.
 *
 * Props:
 *   people        — array of all person objects in the tree
 *   relationship  — existing relationship object (null = add mode)
 *   onSave        — ({ fromPersonId, toPersonId, type }) => Promise<void>
...
export default function RelationshipModal({ people, relationship, onSave, onDelete, onClose }) {
  ...
  async function handleSave(e) {
    ...
    setError('');
    try {
      await onSave({ fromPersonId: fromId, toPersonId: toId, type });
      onClose();
    } catch (err) {
